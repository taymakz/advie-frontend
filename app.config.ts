export default defineAppConfig({
  ui: {
    ...
    button: {
      ...
      variant: {
        solid: 'shadow-sm text-white dark:text-slate-100 bg-{color}-600 hover:bg-{color}-700 disabled:bg-{color}-600 dark:bg-{color}-700 hover:dark:bg-{color}-600 dark:disabled:bg-{color}-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-{color}-500 dark:focus-visible:outline-{color}-400',
      },
    },
    notifications: {
