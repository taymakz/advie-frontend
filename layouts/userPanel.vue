...
<template>
  <div>
    ...
    <main class="bg-gray-100 dark:bg-gray-950 pt-28 md:pt-32 pb-16">
      <div class="container">
        <div class="grid grid-cols-12 gap-5">
          <div class="col-span-3 lg:hidden ">
            <div
              class="flex flex-col divide-y divide-gray-200 dark:divide-gray-700 overflow-hidden bg-white dark:bg-gray-800  rounded-lg border border-gray-200 dark:border-gray-700"
            >
              <!-- User Information -->
          ...
          <div
            class="col-span-9 lg:col-span-12 "
          >
            <slot />
          </div>
        </div>
