<template>
  <footer class="bg-white dark:bg-gray-900 pb-10 relative border-t border-gray-200 dark:border-gray-800 ">
    <!-- Footer Logo -->
    <div class="absolute inset-x-0 flex items-center justify-center -top-3   ">
      <div class="relative flex justify-center h-10 w-12">
        <div class="absolute w-full h-full inset-0 -top-[2px] blur-[4px] bg-stone-50 dark:bg-slate-900 rounded-full">

        </div>
        <svg viewBox="0 0 135 90" fill="none" xmlns="http://www.w3.org/2000/svg"
             class="relative w-7 h-7 text-gray-200">
          <title>Logo</title>
          <path
    ...
    <div class="container">
      ...
      <!-- Contact - Go to Top -->
      <div class="flex flex-row md:flex-col md:gap-y-4 items-center justify-between mt-10">
        <div class="flex flex-row md:flex-col items-center gap-y-4 gap-x-4 text-slate-500 dark:text-slate-400">
          <p class="fa-num text-sm">
            تلفن پشتیبانی ۶۱۹۳۰۰۰۰ - ۰۲۱
          </p>
          <span class="md:hidden h-5 w-[1px] border border-gray-300 dark:border-gray-700">
        ...
        <div class="flex md:order-first">
          <base-button type="button" @click="backToTop" theme="sky" icon="tabler:chevron-up"
                       icon-classes="!text-slate-100 dark:!text-slate-100" class="px-4 py-2">
            برگشت به بالا
          </base-button>
      ...
      <div
          class="flex flex-row md:flex-col md:gap-y-4 gap-x-4 items-center justify-between bg-stone-50 dark:bg-slate-800  mt-10 rounded-xl px-10 py-4  mb-10">
        <div>
      ...
      <div class="grid grid-cols-12 gap-y-10">
        <div class="col-span-6 md:col-span-12 ">
          <div class="grid grid-cols-12 md:justify-items-center">
            <div class="col-span-6 flex flex-col gap-y-5">
              <h5 class="text-slate-600 dark:text-slate-300 text-lg select-none">فروشگاه</h5>
              <ul class="space-y-4 text-slate-500 dark:text-slate-400">
                <li>
                  <nuxt-link to="/" class=" py-2 hover:text-sky-600 hover:dark:text-sky-600">شرایط مرجوعی</nuxt-link>
                </li>
                <li>
                  <nuxt-link to="/" class=" py-2 hover:text-sky-600 hover:dark:text-sky-600">راهنمای خرید</nuxt-link>
                </li>
                <li>
                  <nuxt-link to="/" class=" py-2 hover:text-sky-600 hover:dark:text-sky-600 ">قوانین و مقررات</nuxt-link>
                </li>
                <li>
                  <nuxt-link to="/" class=" py-2 hover:text-sky-600 hover:dark:text-sky-600 ">چرا ما</nuxt-link>
                </li>
              </ul>
            </div>
            <div class="col-span-6 flex flex-col gap-y-5">
              <h5 class="text-slate-600 dark:text-slate-300 text-lg select-none">دسترسی سریع</h5>
              <ul class="space-y-4 text-slate-500 dark:text-slate-400 ">
                <li>
                  <nuxt-link to="/" class=" py-2  hover:text-sky-600 hover:dark:text-sky-600">پیگیری سفارشات</nuxt-link>
                </li>
                <li>
                  <nuxt-link to="/" class=" py-2 hover:text-sky-600 hover:dark:text-sky-600">تماس با ما</nuxt-link>
                </li>
                <li>
                  <nuxt-link to="/" class=" py-2 hover:text-sky-600 hover:dark:text-sky-600">سوالات متداول</nuxt-link>
                </li>
                <li>
                  <nuxt-link to="/" class=" py-2 hover:text-sky-600 hover:dark:text-sky-600">درباره ما</nuxt-link>
                </li>
        ...
        <div class="col-span-4 md:col-span-12 flex items-center justify-end md:justify-center gap-x-2">
          ...
          <nuxt-link to="/" class="w-[140px]  border border-gray-200 dark:border-gray-800 rounded-lg p-2">
            <img src="/namad.png" alt="namad" class="w-full h-auto"/>
          </nuxt-link>
          <nuxt-link to="/" class="w-[140px]  border border-gray-200 dark:border-gray-800 rounded-lg p-2">
            <img src="/namad.png" alt="namad" class="w-full h-auto"/>
          </nuxt-link>
...
import Newsletter from "~/components/shared/footer/items/Newsletter.vue";
