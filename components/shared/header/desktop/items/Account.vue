<template>
  <ClientOnly>
    ...
    <div v-else>
      <!-- Auth-->
      <div v-if="authStore.isLogin" class="relative" ref="accountDropdownSection">
        <div
          ...
          <Icon name="solar:user-outline" size="20"
          ...
          <div>
            <nuxt-link to="/"
              ...
              <div class="flex items-center justify-between gap-x-2">
                <div class="w-8 h-8">
                  <nuxt-img :src="GetImageUrl(authStore.currentUser.profile) ?? ''"
                            alt="User Profile"
                ...
                <div>
                  ...
                  <p class="text-sm font-medium" v-if="authStore.currentUser.first_name">
      ...
      <!-- Not Auth-->
      <div v-else>
        <nuxt-link :to="`/auth/login?backUrl=${router.currentRoute.value.fullPath}`"
