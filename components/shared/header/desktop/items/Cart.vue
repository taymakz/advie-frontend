  ...
  <ClientOnly>
    <div>
      ...
      <div v-else>
        ...
        <div class="relative" ref="cartDropdownSection">
          <div
          ...
          <div
              :class="[{'hidden':!cartDropdown},'absolute z-40  top-14 left-0 bg-white dark:bg-gray-900 border border-gray-200 dark:border-none rounded-lg overflow-hidden']">
            <div v-if="basketStore.getItemsCount > 0">
                        ...
                        <div class="flex flex-col justify-between pr-2">
                          <div class="w-[100px] h-[100px]">
                            <nuxt-link :to="item.product_url">
                              ...
                              <nuxt-img :src="GetImageUrl(item.product_image)" :alt="item.product_title_ir"
                          ...
                          <div class="flex items-center  justify-between gap-x-4 ">
                            <div class="flex flex-col gap-y-1 ">
                              <div class="h-4 ">
                                ...
                                <del v-if="item.variant.is_special"
                              ...
                              <div
                                ...
                                <div class="text-xs font-medium">تومان
                                </div>
                              </div>
                            </div>
                              ...
                              <div
                                ...
                                <template v-else>
                                  <button
                                      ...
                                      @click="basketStore.RemoveItem(item.product_id, item.variant.id)"
                                  >
                                    <Icon name="streamline:interface-delete-bin-1-remove-delete-empty-bin-trash-garbage" size="20"
                                          class="!text-red-600 "/>
                                  </button>
                                </template>
              ...
              <div
                ...
                <div class="flex items-center justify-between select-none mb-4">
                  <p class="text-xs  text-slate-500 dark:text-slate-400 font-iranyekanBold ">مجموع سبد خرید </p>
