<template>
  <ClientOnly>
    <div class="flex-1 max-w-2xl ">
      ...
      <div v-else class="relative" @click="searchDropdown=true" ref="searchDropdownSection">
        <form
            ...
            <div class="flex flex-col p-2 gap-y-2">
              ...
              <div class="flex flex-col gap-y-2">
                <div class="flex items-center justify-start gap-x-2">
                  <div>
                    <Icon name="icon-park-outline:ad-product" size="30"
                      ...
                      <div class="w-60 border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
                        <nuxt-link to="/">
                          <div
                            ...
                            <div>
                              <div class="w-14 h-14">
                                <nuxt-img src="/products/product1.jpg" alt="product"
              ...
              <div class="flex flex-col gap-y-2">
                <div class="flex items-center justify-start gap-x-2">
                  <div>
                    <Icon name="iconamoon:category-light" size="30"
                          class="text-slate-500 dark:text-slate-400"/>
                  </div>
                      ...
                      <div class="w-60 border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
                        <nuxt-link to="/">
                          <div
                            ...
                            <div>
                              <div class="w-14 h-14">
                                <nuxt-img src="/categories/cat.jpg" alt="product"
                                          class="w-full h-auto rounded-lg"/>
                              </div>
                            </div>
                            <div class="flex flex-col justify-evenly gap-y-2">
...
watch(() => utilStore.headerOverlay, (newVal) => {
  if (!newVal) {
    if (searchDropdown.value) searchDropdown.value = false
  }
})
