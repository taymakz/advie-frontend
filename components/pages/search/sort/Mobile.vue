<template>
  ...
  <div class="w-1/2 ">
    <div @click="showSort=true;utilStore.changeHeaderOverlay(true,30)"
    ...
    <div ref="sortSection" :class="{ 'translate-y-full': !showSort }"
      ...
      <div class="flex flex-col items-center gap-y-2">
        <button
            type="button"
        :class="['py-4  relative rounded-lg w-full text-slate-500 dark:text-slate-400 border border-gray-200 dark:border-gray-700',{'!text-sky-500 dark:!text-sky-400 border-sky-500 dark:border-sky-400':selectedSort===ProductSearchSortBy.LATEST}]"
        ...
        <button
            type="button"
            :class="['py-4  relative rounded-lg w-full text-slate-500 dark:text-slate-400 border border-gray-200 dark:border-gray-700',{'!text-sky-500 dark:!text-sky-400 border-sky-500 dark:border-sky-400':selectedSort===ProductSearchSortBy.BEST_SALE}]"
        ...
        <button
            type="button"
   :class="['py-4  relative rounded-lg w-full text-slate-500 dark:text-slate-400 border border-gray-200 dark:border-gray-700',{'!text-sky-500 dark:!text-sky-400 border-sky-500 dark:border-sky-400 ':selectedSort===ProductSearchSortBy.EXPENSIVE}]"
        ...
        <button
            type="button"
      :class="['py-4  relative rounded-lg w-full text-slate-500 dark:text-slate-400 border border-gray-200 dark:border-gray-700',{'!text-sky-500 dark:!text-sky-400 border-sky-500 dark:border-sky-400':selectedSort===ProductSearchSortBy.CHEAPEST}]"
