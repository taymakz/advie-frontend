<template>
  <div class="block md:hidden col-span-10 2xl:col-span-9 lg:col-span-8">
    <div
      ...
      <div>
        <p class="text-sm font-medium select-none">مرتب سازی :</p>
      </div>

      <button
          :class="['py-2 px-2 relative rounded-lg ',{'bg-gray-100 dark:bg-gray-900  text-sky-500 dark:text-sky-400 font-bold':selectedSort===ProductSearchSortBy.LATEST}]"
      ...
      <button
          :class="['py-2 px-2 relative rounded-lg ',{'bg-gray-100 dark:bg-gray-900 text-sky-500 dark:text-sky-400 font-bold':selectedSort===ProductSearchSortBy.BEST_SALE}]"
      ...
      <button
          :class="['py-2 px-2 relative rounded-lg ',{'bg-gray-100 dark:bg-gray-900 text-sky-500 dark:text-sky-400 font-bold':selectedSort===ProductSearchSortBy.EXPENSIVE}]"
      ...
      <button
          :class="['py-2 px-2 relative rounded-lg ',{'bg-gray-100 dark:bg-gray-900 text-sky-500 dark:text-sky-400 font-bold':selectedSort===ProductSearchSortBy.CHEAPEST}]"
