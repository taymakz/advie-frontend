<template>
  <div class="flex flex-col">
    ...
    <div class="flex mb-4">
      <div class="flex items-center justify-between w-full ">
        ...
        <div class="flex items-center">
          ...
          <span class="w-1.5 h-1.5 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>

          <p class="ml-1 text-sm font-medium text-slate-500 dark:text-slate-300 font-iranyekanFanum">4.95</p>
    ...
    <div class="mb-8">
      ...
      <div class="flex flex-wrap  items-center gap-2 border w-full  p-3 rounded-lg border-gray-200 dark:border-gray-800">
       ...
       <USkeleton  class="h-10 w-28" />
          ...
          <div v-else>
            ...
            >
<span class="inline-flex absolute -top-1 -left-1 w-3 h-3 bg-red-500 rounded-full" v-if="item.is_special">
    ...
    <div class="flex  justify-end mb-4">
      ...
      <div class="flex flex-col gap-y-1">
       ...
       <USkeleton v-if="loading" class="h-5 w-32 " />
          ...
          <div v-else class="text-sm font-medium text-red-600  font-iranyekanFanum" v-if="selectedVariant.is_special">
    ...
    <div class="grid grid-cols-12 gap-1 ">
      <div class="flex items-center col-span-6 md:col-span-12 rounded-lg border border-gray-200 hover:border-gray-300 dark:border-gray-800 hover:dark:border-gray-700 h-14 ">
...
import {ProductDetailDTO, Variant} from "~/models/shop/product/ProductDetailDTO";
import {CurrentOrderItemDTO} from "~/models/shop/order/CurrentOrderDTO";
