<template>
  <div class="relative">
    ...
    <div>
      ...
      <Form @submit="loginUser" v-slot="{ meta,validate }" :validation-schema="passwordSchema">


        <base-form-input focus type="password" name="password" v-model="password" :disabled="loading"
                         @focusoutInput="validate"/>
