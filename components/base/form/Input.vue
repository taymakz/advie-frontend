...
<template>
  <div>
    ...
    >
      ...
      <span
        class="absolute start-3 top-3 -translate-y-1/2 cursor-text text-xs  text-gray-500 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-3 peer-focus:text-xs dark:text-gray-400 peer-focus:text-slate-400 peer-focus:dark:text-slate-500"
      >
        {{ label }}
      </span>
    </label>
